...
[!NOTE]
This is a protection mechanism from the upstream project [OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF) and mid have legal implications. Please read up on the details at (https://ocrmypdf.readthedocs.io/en/latest/pdfsecurity.html#digital-signatures)
